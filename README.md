...
Settings → Outfits: Joi·Flowers / Joi·Library

dsh-custom-bg/

Custom Background

Settings → General → “Custom Background”: import a background image and adjust opacity, with settings saved separately for light and dark modes

dsh-maid-whale-pet/

Persistent Mascot

A character that stays at the edge of the page
